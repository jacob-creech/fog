...
def main():
    print '*****FoG Recommender Online*****'
    print '- Enter a Steam ID.\n- Enter \'quit\' to exit.\n- Enter \'help\' to view these tips. \n- Enter \'fog\' to overwrite data files'
    while True:
        steam_64_id = raw_input('> ')
        if steam_64_id == 'fog':
            proceed = raw_input('Proceed with Overwrite?(Y/N): ')
            if proceed == 'y' or proceed == 'Y':
                steam_val.main()
        elif steam_64_id == 'help':
            print '- Enter a Steam ID.\n- Enter \'quit\' to exit.\n- Enter \'help\' to view these tips. \n- Enter \'fog\' to overwrite data files'
        elif steam_64_id == 'quit':
            break
        else:
            alpha = .2
            beta = 1 - alpha
